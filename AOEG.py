...
mutations = [
    ...
    "Focus Siege Weapons",
    "No Blacksmith Upgrades",
    "No Trade (incl carts/caravans)",
    "No Monastery",
    "No Castles",
    "No Monks",
]
...
def viabilityCheck():
    for x in range(len(chosenCivilisations)):
        ...
        if (
            "No Infantry" in chosenMutations[civIndex]
            and "Focus Infantry" in chosenMutations[civIndex]
        ):
            civIndex = x
            ...
            viabilityCheck()
        if (
            "Focus Infantry" in chosenMutations[civIndex]
            and "No Infantry" in chosenMutations[civIndex]
        ):
            civIndex = x
            mutIndex = chosenMutations[civIndex].index("No Infantry")
            replaceMutation(civIndex, mutIndex, "No Infantry")
        ...
        if (
            "No Cavalry (incl Camels and Elephants)" in chosenMutations[civIndex]
            and "Focus Infantry" in chosenMutations[civIndex]
        ):
            civIndex = x
            ...
            replaceMutation(
                civIndex, mutIndex, "No Cavalry (incl Camels and Elephants)"
            )
            viabilityCheck()
        if (
            "Focus Cavalry" in chosenMutations[civIndex]
            and "No Cavalry (incl Camels and Elephants)" in chosenMutations[civIndex]
        ):
            civIndex = x
            mutIndex = chosenMutations[civIndex].index(
                "No Cavalry (incl Camels and Elephants)"
        ...
        if (
            "No Archers (incl Cavalry)" in chosenMutations[civIndex]
            and "Focus Archers" in chosenMutations[civIndex]
        ):
            civIndex = x
            mutIndex = chosenMutations[civIndex].index("No Archers (incl Cavalry)")
            replaceMutation(civIndex, mutIndex, "No Archers (incl Cavalry)")
            viabilityCheck()
        if (
            "Focus Archers" in chosenMutations[civIndex]
            and "No Archers (incl Cavalry)" in chosenMutations[civIndex]
        ):
            civIndex = x
        ...
        if (
            "No Siege Weapons (inc bombard cannons)" in chosenMutations[civIndex]
            and "Focus Siege Weapons" in chosenMutations[civIndex]
        ):
            civIndex = x
            mutIndex = chosenMutations[civIndex].index(
                "No Siege Weapons (inc bombard cannons)"
            ...
            replaceMutation(
                civIndex, mutIndex, "No Siege Weapons (inc bombard cannons)"
            )
            viabilityCheck()
        if (
            "Focus Siege Weapons" in chosenMutations[civIndex]
            and "No Siege Weapons (inc bombard cannons)" in chosenMutations[civIndex]
        ):
            civIndex = x
...
def getResults():
    ...
    for x in range(len(chosenCivilisations)):
        print(
            ...
            + str(x)
            + ", Civilisation: "
            + str(chosenCivilisations[x])
            + ", Mutators: "
            + str(chosenMutations[x])
        )
    print("-------------------------------------------------------------------------")
